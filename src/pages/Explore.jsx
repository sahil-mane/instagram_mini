...
const Explore = () => {
  ...
  const images = [
    ...
    { id: 5, url: "https://picsum.photos/400/650?5", title: "Nature" },
    { id: 6, url: "https://picsum.photos/400/580?6", title: "Sky Mood" },
  ];
  ...
  return (
    <div className="bg-[#F8FAFC] py-8 px-6 max-w-[1280px] mx-auto min-h-screen">
      ...
      <div className="my-8">
        <input
          className="bg-white text-[16px] rounded-3xl py-4 px-6 w-full sm:w-1/3 border border-gray-300 focus:outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-200"
          type="search"
